...
func process(delta) -> void:
	...
	_shell_fur_object.material.set_shader_param("i_physics_pos_offset", -position_diff)
	...
	_shell_fur_object.material.set_shader_param("i_physics_rot_offset", rot_diff)
