...
func process(delta : float) -> void:
	...
	match current_LOD:
		0:
			_shell_fur.material.set_shader_param("i_LOD", 1.0)
		1:
			...
			_shell_fur.material.set_shader_param("i_LOD", lod_value)
	...
	_shell_fur.material.set_shader_param("i_fur_contract", _fur_contract)
